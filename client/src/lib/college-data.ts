...
export const MOCK_COLLEGES: CollegeReview[] = [
  ...
  },
  {
    ...
    city: 'Rohtak',
    type: 'Government',
    description: 'Haryana\'s premier medical institution, a postgraduate institute with a massive 1600-bed hospital and one of the highest patient loads in North India.',
    thumbnail: 'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=600&h=400&fit=crop',
    established: 1960,
    affiliation: 'Pt. B.D. Sharma University of Health Sciences',
    website: 'https://pgimsrohtak.edu.in',
    totalSeats: 200,
    coursesOffered: ['MBBS', 'MD', 'MS', 'DM', 'MCh'],
    neetCutoffRange: 'AIR 5,000 - 15,000 (General, State)',
    annualFees: '~55,000/yr',
    about: 'Pt. Bhagwat Dayal Sharma Post Graduate Institute of Medical Sciences (PGIMS), Rohtak, established in 1960, is the apex health and medical education institute of Haryana. It functions both as a medical college and a university of health sciences, granting degrees across all health science disciplines. The 1600-bed hospital is the largest government hospital in Haryana and serves as the main referral center for the state.',
    facultyQuality: 'The institute has a strong faculty base with over 350 professors and specialists. Being a PGIMS, many faculty are actively involved in postgraduate teaching and research. The departments of Orthopedics, General Surgery, and Pulmonary Medicine are nationally recognized.',
    campusInfrastructure: 'Spread over 250 acres, the campus has modern teaching blocks, a digital library, simulation center, auditorium, and sports facilities. The campus has been significantly upgraded with new academic blocks and hostels in recent years.',
    hospitalFacilities: 'The 1600-bed teaching hospital has comprehensive departments including a dedicated Trauma Centre, Burns Unit, Cardiac Catheterization Lab, and Advanced Cancer Treatment Center. A new super-specialty block has been added.',
    clinicalExposure: 'Being the primary referral hospital for Haryana and neighboring regions, clinical exposure is massive. Students see cases from across rural and urban Haryana. Emergency medicine training is particularly strong.',
    patientLoad: 'Annual OPD visits: ~2.8 million | Annual admissions: ~75,000 | Annual surgeries: ~35,000 | Emergency cases: ~200,000/yr.',
    hostelFacilities: 'Separate hostels for boys and girls with mess facilities. The campus is self-contained with banking, postal, and shopping facilities.',
    studentLife: 'Active sports and cultural scene. Rohtak is well-connected to Delhi (70 km) via expressway. Annual cultural fest "Utsav" is popular. Several student welfare programs operate on campus.',
    pros: ['Premier institute of Haryana with PGIMS status', 'Massive patient volume for clinical exposure', 'Proximity to Delhi NCR', 'Affordable government fees', 'Strong trauma and emergency training', 'University status provides degree directly'],
    cons: ['Rohtak city has limited entertainment options', 'Some older hostel blocks need renovation', 'Hot summers in Haryana can be challenging', 'Competition for Haryana state quota'],
    gallery: [
      { url: 'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=800&h=500&fit=crop', caption: 'PGIMS Campus' },
      { url: 'https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=800&h=500&fit=crop', caption: 'Hospital Building' },
    ],
    reviewVideos: [{ title: 'PGIMS Rohtak Campus Tour', embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }],
  },
  {
    id: 'college-24',
    ...
    city: 'Cuttack',
    type: 'Government',
    description: 'Odisha\'s oldest and most prestigious medical college with the largest government hospital in the state. Known for exceptional surgical training and handling cyclone disaster relief.',
    thumbnail: 'https://images.unsplash.com/photo-1504439468489-c8920d796a29?w=600&h=400&fit=crop',
    established: 1944,
    affiliation: 'Utkal University',
    website: 'https://scbmch.nic.in',
    totalSeats: 250,
    coursesOffered: ['MBBS', 'MD', 'MS', 'DM'],
    neetCutoffRange: 'AIR 8,000 - 25,000 (General, State)',
    annualFees: '~30,000/yr',
    about: 'SCB Medical College and Hospital, Cuttack, established in 1944, is the premier medical institution of Odisha. The associated hospital has 2100+ beds and serves as the apex referral center for the entire state. It has a distinguished history of producing outstanding surgeons and physicians. The college played a critical role in medical relief during multiple cyclone disasters.',
    facultyQuality: 'Strong clinical faculty with decades of experience. The Departments of Surgery, Medicine, and Orthopedics are particularly well-regarded. Faculty are known for pragmatic clinical teaching and hands-on approach.',
    campusInfrastructure: 'Heritage campus in the heart of Cuttack city. Library, lecture halls, and anatomy museum are notable. Infrastructure has been upgraded with new PG hostel blocks and OPD building.',
    hospitalFacilities: 'SCB Hospital (2100+ beds) is Odisha\'s largest. Dedicated Burns Ward, Trauma Centre, Dialysis Unit, and Cath Lab. The hospital handles referrals from all 30 districts of Odisha.',
    clinicalExposure: 'Exceptional clinical exposure due to high patient volume from across Odisha. Students get extensive hands-on experience. Snake bite management and tropical medicine exposure is unique.',
    patientLoad: 'Annual OPD visits: ~2 million | Annual admissions: ~70,000 | Annual surgeries: ~30,000 | Emergency cases: ~150,000/yr.',
    hostelFacilities: 'On-campus hostels with basic amenities. Mess facilities available. Cuttack offers affordable living costs.',
    studentLife: 'Active cultural scene with annual fest. Cuttack, the silver city of Odisha, offers rich cultural experiences. Proximity to Bhubaneswar provides additional amenities. Strong alumni network.',
    pros: ['Odisha\'s top medical college', 'Massive clinical exposure', 'Very affordable fees', 'Strong surgical training tradition', 'Good PG opportunities within the college'],
    cons: ['Infrastructure is dated in some sections', 'Limited research funding compared to central institutes', 'Cuttack has limited metropolitan amenities', 'Hot and humid climate'],
    gallery: [
      { url: 'https://images.unsplash.com/photo-1504439468489-c8920d796a29?w=800&h=500&fit=crop', caption: 'SCB Medical College' },
      { url: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&h=500&fit=crop', caption: 'Hospital Campus' },
    ],
    reviewVideos: [{ title: 'SCB Medical College Cuttack', embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }],
  },
  {
    id: 'college-25',
    ...
    city: 'Ranchi',
    type: 'Government',
    description: 'Jharkhand\'s premier medical institution located in the scenic hill city of Ranchi. Serves as the primary referral hospital for the entire state with a 1200-bed facility.',
    thumbnail: 'https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=600&h=400&fit=crop',
    established: 1960,
    ...
    neetCutoffRange: 'AIR 12,000 - 35,000 (General, State)',
    annualFees: '~20,000/yr',
    about: 'Rajendra Institute of Medical Sciences (RIMS), Ranchi, is the top medical college in Jharkhand. Established in 1960, it serves as the primary tertiary care facility for the state. The 1200-bed hospital handles complex cases referred from all districts. Ranchi\'s pleasant climate makes it one of the more comfortable locations for medical studies.',
    facultyQuality: 'Dedicated faculty with strong clinical expertise. The departments of Medicine, Surgery, and Pediatrics have experienced teachers. Faculty development programs have been strengthened in recent years.',
    campusInfrastructure: 'Green campus in Ranchi with modern lecture halls, library, and recently upgraded laboratories. The climate is pleasant year-round, making it an agreeable study environment.',
    hospitalFacilities: 'RIMS Hospital has 1200 beds with departments across all major specialties. Trauma centre, dialysis unit, and NICU are key facilities. The hospital serves as Jharkhand\'s primary referral center.',
    clinicalExposure: 'Good clinical exposure with diverse case mix from tribal and rural populations. Unique exposure to tropical diseases, malnutrition cases, and tribal health challenges.',
    patientLoad: 'Annual OPD visits: ~1.5 million | Annual admissions: ~55,000 | Annual surgeries: ~20,000.',
    hostelFacilities: 'On-campus hostels with mess. Ranchi\'s affordable cost of living is a plus. The city has pleasant weather unlike many other medical college locations.',
    studentLife: 'Ranchi is known as "City of Waterfalls." Students enjoy nature excursions to Hundru Falls, Jonha Falls, and Betla National Park. Active sports scene with cricket and football tournaments. Growing IT sector adds to the city\'s development.',
    pros: ['Top medical college in Jharkhand', 'Pleasant Ranchi climate year-round', 'Very affordable fees and living costs', 'Unique tribal health exposure', 'Growing city infrastructure'],
    cons: ['Limited metropolitan amenities compared to tier-1 cities', 'Connectivity could be better', 'Research infrastructure needs improvement', 'Some departments understaffed'],
    gallery: [
      { url: 'https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=800&h=500&fit=crop', caption: 'RIMS Campus' },
    ],
    reviewVideos: [{ title: 'RIMS Ranchi Campus Life', embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }],
  },
  {
    id: 'college-26',
    name: 'Government Medical College, Thiruvananthapuram',
    ...
    city: 'Thiruvananthapuram',
    type: 'Government',
    description: 'Kerala\'s oldest and most prestigious medical college, known for exceptional public health programs and highest literacy-driven healthcare standards in India.',
    ...
    website: 'https://gmctvm.org',
    totalSeats: 250,
    coursesOffered: ['MBBS', 'MD', 'MS', 'DM', 'MCh'],
    neetCutoffRange: 'AIR 3,000 - 10,000 (General, State)',
    annualFees: '~28,000/yr',
    about: 'Government Medical College (GMC), Thiruvananthapuram, established in 1951, is the flagship medical institution of Kerala. Associated with the SAT Hospital (2200 beds), it is the primary referral center for southern Kerala. Kerala\'s exceptional healthcare indicators — highest life expectancy, lowest infant mortality, near-universal literacy — make this college a unique training ground for community and preventive medicine.',
    facultyQuality: 'Excellent faculty across departments. Kerala\'s strong healthcare system produces well-trained clinicians. The departments of Cardiology, Neurology, and Community Medicine are nationally recognized. Research output is significant.',
    campusInfrastructure: 'Located in the capital city, the campus has modern facilities including a well-stocked library, simulation lab, and research center. Kerala\'s investment in public health infrastructure benefits the college directly.',
    hospitalFacilities: 'SAT Hospital has 2200 beds with comprehensive departments. Super-specialty services in Cardiology, Neurosurgery, Nephrology, and Oncology. The Regional Cancer Centre is adjacent for oncology training.',
    clinicalExposure: 'Excellent exposure with Kerala\'s high health-seeking population. Students see well-documented cases with good follow-up rates. Community medicine and public health exposure is among the best in India.',
    patientLoad: 'Annual OPD visits: ~2 million | Annual admissions: ~65,000 | Annual surgeries: ~28,000.',
    hostelFacilities: 'Hostels with good amenities. Kerala cuisine is available in mess. Thiruvananthapuram offers excellent quality of life with beaches, cultural events, and a safe environment.',
    studentLife: 'Thiruvananthapuram is Kerala\'s capital with beaches, museums, and a vibrant cultural scene. Students enjoy a high quality of life. Kerala\'s strong cultural emphasis on education creates a supportive academic environment. Onam and Christmas celebrations are major campus events.',
    pros: ['Kerala\'s premier medical college', 'Excellent community medicine training', 'High quality of life in capital city', 'Strong healthcare system support', 'Beautiful coastal location', 'Safe and clean environment'],
    cons: ['Competitive Kerala state quota', 'Malayalam proficiency helps for patient interaction', 'Some infrastructure is aging', 'Limited seat count for AIQ'],
    gallery: [
      { url: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800&h=500&fit=crop', caption: 'Medical College Campus' },
      { url: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&h=500&fit=crop', caption: 'SAT Hospital' },
    ],
    reviewVideos: [{ title: 'GMC Thiruvananthapuram Campus', embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }],
  },
  {
    id: 'college-27',
    ...
    city: 'Ludhiana',
    type: 'Private',
    description: 'One of India\'s top private medical colleges, DMCH Ludhiana is known for its Hero DMC Heart Centre and excellent surgical training with a 1150-bed multi-specialty hospital.',
    thumbnail: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&h=400&fit=crop',
    established: 1934,
    ...
    totalSeats: 150,
    coursesOffered: ['MBBS', 'MD', 'MS', 'DM', 'MCh'],
    neetCutoffRange: 'AIR 15,000 - 40,000 (General)',
    annualFees: '~12,50,000/yr',
    about: 'Dayanand Medical College and Hospital (DMCH), Ludhiana, established in 1934 by the Arya Samaj, is one of India\'s oldest and most respected private medical colleges. The 1150-bed hospital includes the renowned Hero DMC Heart Centre. DMCH has consistently been ranked among the top 20 medical colleges in India. It combines affordable private education with clinical excellence.',
    facultyQuality: 'Exceptional faculty with many being alumni who returned to teach. The Department of Cardiothoracic Surgery and the Emergency Department are nationally acclaimed. Strong emphasis on clinical skills over rote learning.',
    campusInfrastructure: '30-acre campus with modern infrastructure. Smart classrooms, well-equipped simulation lab, digital anatomy lab, and a central research facility. Campus is well-maintained with green spaces.',
    hospitalFacilities: '1150-bed multi-specialty hospital with Hero DMC Heart Centre (one of the best cardiac centers in North India), Trauma Centre, NICU, and comprehensive ICU facilities. The hospital is NABH accredited.',
    clinicalExposure: 'Excellent clinical exposure with strong emphasis on emergency and cardiac cases. Ludhiana serves a large industrial population with frequent trauma and cardiac emergencies. Students get hands-on experience early.',
    patientLoad: 'Annual OPD visits: ~1.5 million | Annual admissions: ~50,000 | Annual surgeries: ~25,000 | Annual cardiac surgeries: ~3000.',
    hostelFacilities: 'Well-maintained hostels with AC rooms available. Good mess with Punjabi cuisine. Campus has recreation facilities including gym and sports grounds.',
    studentLife: 'Ludhiana is Punjab\'s largest city with vibrant food culture and Punjabi hospitality. Students enjoy the lively campus culture. Annual fest is celebrated with enthusiasm. The city is well-connected to Chandigarh and Delhi.',
    pros: ['Top-ranked private medical college', 'Excellent cardiac surgery center', 'Strong clinical training emphasis', 'Relatively affordable for private college', 'Vibrant Punjab campus culture', 'Good placement for PG'],
    cons: ['Private college fees (though competitive)', 'Ludhiana air quality can be poor in winters', 'Limited research compared to government institutes', 'Punjab state reservation rules can be complex'],
    gallery: [
      { url: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&h=500&fit=crop', caption: 'DMCH Hospital' },
      { url: 'https://images.unsplash.com/photo-1582719471384-894fbb16e074?w=800&h=500&fit=crop', caption: 'Campus View' },
    ],
    reviewVideos: [{ title: 'DMCH Ludhiana Review', embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }],
  },
  {
    id: 'college-28',
    ...
    city: 'Rishikesh',
    type: 'Government',
    description: 'One of the newest AIIMS in India, built with state-of-the-art infrastructure from scratch. Located in the yoga capital of the world with a stunning Himalayan backdrop.',
    thumbnail: 'https://images.unsplash.com/photo-1551076805-e1869033e561?w=600&h=400&fit=crop',
    established: 2012,
    affiliation: 'AIIMS (Autonomous)',
    website: 'https://aiimsrishikesh.edu.in',
    totalSeats: 125,
    coursesOffered: ['MBBS', 'B.Sc Nursing', 'MD', 'MS'],
    neetCutoffRange: 'AIR 2,000 - 8,000 (General)',
    annualFees: '~1,628/yr',
    about: 'AIIMS Rishikesh was established in 2012 under the Pradhan Mantri Swasthya Suraksha Yojana (PMSSY). Unlike older AIIMS, it was built from the ground up with modern architecture and latest medical technology. Located on a 217-acre campus on the banks of the Ganges with views of the Himalayas, it is already emerging as a premier medical institution. The hospital has grown to 960 beds and is rapidly expanding to 2500.',
    facultyQuality: 'Young, dynamic faculty recruited nationally. Many have trained at AIIMS Delhi, PGIMER, and international institutions. Active research culture with focus on high-altitude medicine and disaster management.',
    campusInfrastructure: 'Brand-new 217-acre campus with ultramodern academic blocks, smart lecture halls, advanced simulation center, and one of the best medical libraries in the country. The campus is Wi-Fi enabled with sustainable architecture.',
    hospitalFacilities: '960-bed hospital (expanding to 2500) with all super-specialty departments. Helipad for emergency evacuations. State-of-the-art modular OTs, PET-CT scanner, and advanced trauma center.',
    clinicalExposure: 'Growing patient volume as the hospital establishes itself. Unique exposure to high-altitude medicine, adventure sports injuries, and cases from Uttarakhand\'s hill regions. Students benefit from modern equipment and techniques.',
    patientLoad: 'Annual OPD visits: ~800,000 | Annual admissions: ~35,000 | Annual surgeries: ~15,000. Patient volume is growing rapidly year on year.',
    hostelFacilities: 'Modern hostels with excellent amenities. Stunning views of the Himalayas from hostel windows. Clean air and pleasant climate. Well-maintained mess with good food.',
    studentLife: 'Rishikesh is the yoga capital of the world. Students enjoy river rafting, trekking, and Himalayan excursions. The spiritual atmosphere and natural beauty make it a unique medical college experience. Haridwar is 20 km away.',
    pros: ['AIIMS brand with negligible fees', 'Brand-new world-class infrastructure', 'Spectacular Himalayan location', 'Clean air and natural surroundings', 'Modern teaching methodology', 'Growing into a premier institution'],
    cons: ['Relatively new — still building reputation', 'Rishikesh is a small town with limited urban amenities', 'Distance from major metro cities', 'Patient volume still growing compared to older AIIMS'],
    gallery: [
      { url: 'https://images.unsplash.com/photo-1551076805-e1869033e561?w=800&h=500&fit=crop', caption: 'AIIMS Rishikesh Campus' },
      { url: 'https://images.unsplash.com/photo-1582719471384-894fbb16e074?w=800&h=500&fit=crop', caption: 'Mountain View from Campus' },
    ],
    reviewVideos: [{ title: 'AIIMS Rishikesh Campus Tour', embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }],
  },
  {
    id: 'college-29',
    ...
    city: 'Guwahati',
    type: 'Government',
    description: 'The premier medical institution of Northeast India, established in 1960. Gauhati Medical College Hospital is the largest government hospital in the Northeast with 2000+ beds.',
    thumbnail: 'https://images.unsplash.com/photo-1504439468489-c8920d796a29?w=600&h=400&fit=crop',
    established: 1960,
    ...
    totalSeats: 250,
    coursesOffered: ['MBBS', 'MD', 'MS', 'DM'],
    neetCutoffRange: 'AIR 10,000 - 30,000 (General, State)',
    annualFees: '~18,000/yr',
    about: 'Gauhati Medical College (GMC), established in 1960, is the oldest and most prestigious medical college in Northeast India. The associated GMCH Hospital has 2000+ beds and serves as the apex referral center for the entire Northeast region (8 states). The college has produced many distinguished doctors who serve across the country and abroad.',
    facultyQuality: 'Experienced faculty with deep understanding of healthcare challenges specific to Northeast India. Strong departments in Medicine, Pediatrics, and Obstetrics. Faculty actively contribute to tropical disease research.',
    campusInfrastructure: 'Located in the heart of Guwahati near Bharalu river. Heritage campus with ongoing modernization. New academic blocks and upgraded laboratories. Digital library and e-learning facilities.',
    hospitalFacilities: 'GMCH (2000+ beds) is the largest hospital in Northeast India. Comprehensive departments including Regional Cancer Centre, Cardiac Catheterization Lab, and Level 1 Trauma Centre. Serves referrals from 8 northeastern states.',
    clinicalExposure: 'Unique clinical exposure to diseases prevalent in Northeast India including tropical infections, snake bites, and ethnic-specific conditions. High patient volume from across the region ensures diverse case mix.',
    patientLoad: 'Annual OPD visits: ~1.8 million | Annual admissions: ~65,000 | Annual surgeries: ~25,000. Referrals from across 8 NE states.',
    hostelFacilities: 'On-campus hostels with basic amenities. Guwahati offers affordable living. Assamese cuisine is unique and delicious.',
    studentLife: 'Guwahati is the gateway to Northeast India. Students enjoy access to wildlife sanctuaries, tea gardens, and cultural diversity of NE states. Bihu celebrations on campus are legendary. The Brahmaputra river adds to the scenic beauty.',
    pros: ['Premier medical college of entire Northeast', 'Very affordable fees', 'Unique tropical disease exposure', 'Gateway to culturally rich Northeast', 'Large hospital with diverse cases', 'Beautiful natural surroundings'],
    cons: ['Connectivity to mainland India is limited', 'Monsoon flooding can affect the area', 'Infrastructure needs continuous upgrades', 'Limited research funding'],
    gallery: [
      { url: 'https://images.unsplash.com/photo-1504439468489-c8920d796a29?w=800&h=500&fit=crop', caption: 'GMC Guwahati Campus' },
    ],
    reviewVideos: [{ title: 'Gauhati Medical College Life', embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }],
  },
  {
    id: 'college-30',
    ...
    city: 'Kochi',
    type: 'Deemed',
    description: 'A world-class deemed university hospital in Kochi known for its ethical healthcare model, NABH & JCI accreditation, and pioneering organ transplant programs in South India.',
    thumbnail: 'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&h=400&fit=crop',
    established: 1998,
    affiliation: 'Amrita Vishwa Vidyapeetham (Deemed University)',
    website: 'https://aims.amrita.edu',
    totalSeats: 150,
    coursesOffered: ['MBBS', 'MD', 'MS', 'DM', 'MCh'],
    neetCutoffRange: 'AIR 10,000 - 35,000 (General)',
    annualFees: '~15,00,000/yr',
    about: 'Amrita Institute of Medical Sciences (AIMS), Kochi, established in 1998, is part of the Amrita Vishwa Vidyapeetham deemed university. The 1300-bed NABH and JCI accredited hospital is one of the most technologically advanced in India. AIMS is known for its ethical, compassionate healthcare model inspired by the humanitarian values of Mata Amritanandamayi. It has pioneered robotic surgery, organ transplants, and rare disease treatments in South India.',
    facultyQuality: 'Top-tier faculty recruited from across India and abroad. Many professors are fellowship-trained in international centers. Strong emphasis on research with dedicated research center. Active clinical trial participation.',
    campusInfrastructure: '150-acre lush green campus on the outskirts of Kochi. State-of-the-art academic complex with advanced simulation lab, anatomy museum, and dedicated research wings. Modern auditorium and sports facilities.',
    hospitalFacilities: '1300-bed JCI accredited hospital with 25 super-specialties. India\'s first Cyberknife Robotic Radiosurgery System. Advanced robotic surgery programs. Comprehensive organ transplant program (heart, liver, kidney, bone marrow).',
    clinicalExposure: 'Excellent exposure to cutting-edge medical procedures. Students witness robotic surgeries, transplants, and rare disease management. The hospital\'s ethical healthcare model ensures students learn compassionate patient care.',
    patientLoad: 'Annual OPD visits: ~1.2 million | Annual admissions: ~45,000 | Annual surgeries: ~25,000 | Organ transplants: ~200/yr.',
    hostelFacilities: 'Well-furnished hostels with AC rooms. Excellent mess with Kerala and multi-cuisine options. Campus has recreation center, gym, and yoga facilities. Safe and secure environment.',
    studentLife: 'Kochi is India\'s most cosmopolitan city in Kerala. Students enjoy marine drives, backwaters, Fort Kochi heritage, and vibrant food scene. The campus promotes holistic development with yoga, meditation, and community service. Cultural diversity with international student exchange programs.',
    pros: ['JCI accredited — international standard hospital', 'Cutting-edge technology (robotic surgery, CyberKnife)', 'Beautiful Kerala campus with excellent facilities', 'Strong research culture', 'Ethical healthcare values', 'Cosmopolitan Kochi city'],
    cons: ['Deemed university fees are high', 'Newer institution compared to legacy colleges', 'Competition for deemed quota seats', 'Management quota can be expensive'],
    gallery: [
      { url: 'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=800&h=500&fit=crop', caption: 'AIMS Hospital' },
      { url: 'https://images.unsplash.com/photo-1582719471384-894fbb16e074?w=800&h=500&fit=crop', caption: 'Campus Gardens' },
    ],
    reviewVideos: [{ title: 'AIMS Kochi Campus & Hospital Tour', embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }],
  },
];
