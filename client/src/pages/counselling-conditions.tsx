    ...
    <div className="space-y-6 pb-10 page-enter">
      ...
      <div className="flex items-center justify-center">
        <span className="inline-flex items-center gap-2 text-xs font-medium text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-3.5 py-1.5 rounded-full">
          ...
          {isQuotaTab
            ? quotaInfo && <> for <span className="font-bold text-emerald-600 dark:text-emerald-400">{quotaInfo.label}</span></>
            : <> conditions · <span className="font-bold text-emerald-600 dark:text-emerald-400">All-India baseline</span></>
          }
