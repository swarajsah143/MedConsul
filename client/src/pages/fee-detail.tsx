  ...
  return (
    <div className="space-y-6 pb-10 page-enter">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          { label: 'Total 1st Year', value: formatINRFull(totalFirstYear), icon: IndianRupee, color: 'text-emerald-600', bg: 'bg-emerald-50 dark:bg-emerald-950/30' },
            ...
            <CardContent className="p-0">
              <div className="divide-y divide-slate-100 dark:divide-slate-800">
                ...
                <div className="flex items-center justify-between px-6 py-3.5 bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-950/20 dark:to-green-950/20 text-xs font-bold">
                  ...
                  <span className="text-emerald-700 dark:text-emerald-400 tabular-nums text-sm">{formatINRFull(totalFirstYear)}</span>
                </div>
              </div>
            </CardContent>
          </Card>
